...
@SequenceGenerator(name = "generator_sq_planos", sequenceName = Constants.SQ_PLANOS, allocationSize = 1)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class Planos implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator_sq_planos")
	@NotNull
